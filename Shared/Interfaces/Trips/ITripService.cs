...
public interface ITripService
{
    ...
    Task<List<TruckTripReportDto>> GetTruckReportAsync(TruckTripReportFilter filter, CancellationToken cancellationToken);
    Task<List<DriverTripReportDto>> GetDriverReportAsync(DriverTripReportFilter filter, CancellationToken cancellationToken);
